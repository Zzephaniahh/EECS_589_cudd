...
#export PATH=/home/zephaniah/Documents/Minisat_EECS598/translator_tool
...
output.Push(mgr.BddToAdd(f)) # only g is printed, reverse order of the push calls to print only f
